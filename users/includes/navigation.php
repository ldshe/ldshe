...
?>
<!-- Navigation -->
<div class="navbar navbar-fixed-top navbar-inverse menu" role="navigation">
	<div class="container">
		<!-- Brand and toggle get grouped for better mobile display -->
		<div class="navbar-header lds-logo">
			...
			<a href="<?=$us_url_root?>"><img class="img-responsive" src="<?=$us_url_root?>users/images/logo.png" alt="" /></a>
			<?php require_once $abs_us_root.$us_url_root.'users/includes/about.php';?>
		</div>
		<div class="collapse navbar-collapse navbar-top-menu-collapse about">
			<ul class="nav navbar-nav">
				<li>
					...
					<ul class="dropdown-menu">
						<li><a href="<?=$us_url_root?>users/about/concept.php">Conceptual Underpinnings</a></li>
						<li><a href="<?=$us_url_root?>users/about/guide.php">User guide</a></li>
						<li><a href="<?=$us_url_root?>users/about/publications.php">Publications</a></li>
						<li><a href="<?=$us_url_root?>users/about/team.php"><b>LDS<sup>HE</sup></b> Team Members</a></li>
						<li><a href="<?=$us_url_root?>users/about/alliance.php">HKUST MIT Research Alliance Consortium</a></li>
					</ul>
				</li>
			</ul>
		</div>
...
<?php require_once $abs_us_root.$us_url_root.'usersc/includes/navigation_right_side.php'; ?>
                    ...
                    <li class="dropdown hidden-xs notification"></li>
