...
export default class CuratorPatternList extends Component {
    ...
    renderSettings() {
        const {configLoadedNum, editCollectId, acls, data} = this.props.list;
        const {loadPatternList, resetSettings, loadPatternConfig, configurePattern, getAlertify} = this.props;
        let list = {
            configLoadedNum,
        ...
        let props = {
            ...
            title: fullname,
            list,
            refreshList: () => loadPatternList(ListType.CURATOR),
            resetSettings,
