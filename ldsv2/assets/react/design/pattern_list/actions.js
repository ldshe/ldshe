...
const stateName = StateName.PATTERN_LIST;

const BaseActions = Object.assign({},
    new createListActions(ListAction, StateName.PATTERN_LIST),
    new createSettingsActions(ListAction, StateName.PATTERN_LIST)
);
...
export const setEditCollection = editCollectId => {
    let payload = {editCollectId};
    return {type: ListAction.SET_EDIT_COLLECTION, payload};
}
